...
//              ["h", "when IR remote %m.buttons pressed port %m.whichInputPort", "whenRemoteButtonPressed","Top Left", "1"],
              ...
              ["w", "suona la frequenza %n per %n ms",                    "playFreq",         "262", 500],
              ["R", "misura del sensore di luce in modalità %m.lightSensorMode sulla porta%m.whichInputPort",   "readColorSensorPort",   "1", "colore"],
              ["R", "misura della distanza sulla porta %m.whichInputPort",                  "readDistanceSensorPort",   "1"],
